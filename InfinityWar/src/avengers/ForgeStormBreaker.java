 ...
 *    3. java -cp bin avengers/ForgeStormBreaker forgestormbreaker3.in forgestormbreaker3.out
 *
 * @author Yashas Ravi
 * 
 */
...
public class ForgeStormBreaker {
	public static void main (String [] args) {
        ...
        for(int r = 0; r < fluxArray.length; r++){
            for(int c = 0; c < fluxArray[0].length; c++){
